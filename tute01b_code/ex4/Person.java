package tute01b_code.ex4;

import tute01b_code.ex1.MobilePhone;
 ...
 *    name.match("Word{2,*}")=true /\ name.includes(" ")=true /\ 
...
public class Person {
    ...
    private boolean validateName(String name) {
        ...
        // name.match("Word{2,*}")=true /\ name.includes(" ")=true
        // TODO: use name.matches()
        return name.indexOf(" ") > 0 && name.trim().length() >= 2;
    }
