package tute01b_code.ex3;
import tute01b_code.ex2.Color;
 ...
 *    model.match("M-Letter{3}-Digit{3}")=true /\ 
...
public class MobilePhone {
  ...
  private boolean validateModel(String model) {
    ...
    // "M-Letter{3}-Digit{3}"
    final String modelPattern = "M-[a-zA-Z]{3}-[\\d]{3}";
    return model.matches(modelPattern);
  }
